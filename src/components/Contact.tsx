    ...
    <section id="contact" className="relative px-5 py-24 md:px-6 md:py-40">
      ...
      <div className="grid gap-10 md:grid-cols-2 md:gap-16">
        ...
        <div className="relative aspect-[4/3] w-full overflow-hidden rounded-sm border border-foreground/30 md:aspect-auto md:min-h-[420px]">
          ...
          <MapPin
            aria-hidden="true"
            className="pointer-events-none absolute left-1/2 top-1/2 z-10 h-12 w-12 -translate-x-1/2 -translate-y-full fill-foreground text-foreground drop-shadow-[0_2px_6px_rgba(0,0,0,0.45)] md:h-14 md:w-14"
            strokeWidth={2.5}
          />
        </div>
